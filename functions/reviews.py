...
cloudant_username = '71698bba-7750-40ae-bff6-cd9f29a6a9cc-bluemix'
cloudant_api_key = 'S36x4mKcIYgxTkNqvudKgQjrnb-7sxY936XqseHsFgA9'
cloudant_url = 'https://71698bba-7750-40ae-bff6-cd9f29a6a9cc-bluemix.cloudantnosqldb.appdomain.cloud'
...
def post_review():
    ...
    required_fields = ['name', 'dealership', 'review', 'purchase', 'purchase_date', 'car_model', 'car_year']
    for field in required_fields:
        if field not in review_data:
            return jsonify({"message": f'Missing required field: {field}'}), 400

    # Save the review data as a new document in the Cloudant database
    review_data['id'] = db.doc_count() + 1
